...
type FieldName = 'name' | 'project' | 'startDate' | 'status'
...
function validate(): boolean {
  errors.name = form.name.trim() ? '' : 'Informe o nome da tarefa.'
  errors.project = form.project ? '' : 'Selecione um projeto.'
